...
public class NamedEntityRecognitionHandler {
    ...
    private String[] entityTypes = {"PERSON", "LOCATION", "ORGANIZATION"};
    ...
    public void printEntities(String review) {
        ...
        for (CoreMap sentence : sentences) {
            ...
            for (CoreLabel token : sentence.get(TokensAnnotation.class)) {
                ...
                if(Arrays.asList(entityTypes).contains(ne)) {
    ...
    public String getEntities(String review) {
        ...
        for (CoreMap sentence : sentences) {
            ...
            for (CoreLabel token : sentence.get(TokensAnnotation.class)) {
                ...
                String ne = token.get(NamedEntityTagAnnotation.class);
                if(Arrays.asList(entityTypes).contains(ne)) {
                    namedEntities.add(word + ":" + ne);
                }
            }
        }
        return "[" + String.join(", ", namedEntities) + "]";
    }
}
